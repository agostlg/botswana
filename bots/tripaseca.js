...
var TripaSeca = function() {};

TripaSeca.prototype = new Bot();

TripaSeca.prototype.setup = function() {
	// For getDirection()
	this.attrStrength = 8;
	this.safety = 9;
	this.repStrength = 4;
...
TripaSeca.prototype.acquireTarget = function() {
	target = undefined;
...
TripaSeca.prototype.run = function() {
	target = undefined;
	command = '';
...
server.registerBotScript("TripaSeca");
